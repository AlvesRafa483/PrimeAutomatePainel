import React, { Component, Fragment } from 'react';
  ...
  class CustomDeleteButton extends Component {
    ...
    handleDelete = (event) => {
      ...
      this.setState({ showDialog: false });
      const { dispatchCrudDelete, startUndoable, resource, record, undoable } = this.props;
      if (undoable) {
      ...
      return (
        <Fragment>
          ...
          <form action="/" method="POST" onSubmit={this.handleDelete}>
            ...
            <DialogContent>
              <DialogContentText>
              Are you sure You want to Delete User {this.props.record.userEmail} ?
             </DialogContentText>
            </DialogContent>
            <DialogActions>
              <Button  type="submit" label="ra.action.delete" className={classnames('ra-delete-button', classes.deleteButton, className)} key="button">
                <ActionDelete />
              </Button>
